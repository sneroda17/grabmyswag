...
namespace EllisIO\Phone\Facades { 
    ...
    class Phone {
        ...
        public static function driver($name = null)
        {
            return \EllisIO\Phone\PhoneFactory::driver($name);
        }
        ...
        public static function getDefaultDriver()
        {
            return \EllisIO\Phone\PhoneFactory::getDefaultDriver();
        }
        ...
        public static function setDefaultDriver($name)
        {
            return \EllisIO\Phone\PhoneFactory::setDefaultDriver($name);
        }
...
namespace  { 
    ...
    class Phone extends \EllisIO\Phone\Facades\Phone {}
